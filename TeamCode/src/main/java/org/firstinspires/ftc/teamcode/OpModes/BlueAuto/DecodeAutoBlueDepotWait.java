...
@Autonomous
public class DecodeAutoBlueDepotWait extends OpMode {
    ...
    public void init() {
        ...
        commandScheduler.schedule(new WaitCommand(10000), new InstantCommand(()->chassis.setMaxSpeed(.8)), firstSegment, secondSegment, thirdSegment,
