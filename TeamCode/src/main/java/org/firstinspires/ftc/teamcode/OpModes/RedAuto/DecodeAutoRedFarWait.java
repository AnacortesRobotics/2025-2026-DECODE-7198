...
@Autonomous
public class DecodeAutoRedFarWait extends OpMode {
...
//        trajectory = new LinearTrajectory(telemetry, new Pose2D(DistanceUnit.INCH, 0, 0, AngleUnit.DEGREES, 0));
        ...
        poseFarShoot = new RobotPose(-69, -25, -17.0, true);
        poseMiddleShoot = new RobotPose(30, -30, -45, true);
        moveToEnd = new RobotPose(-69, -50, 0, true);
        moveToCollect1stcycle = new RobotPose(-45, -36, -90, true);
        moveToCollect1stcycle1stBall = moveToCollect1stcycle.plusY(-5);
...
//                        wait,
                        indexer.fireSlot(RobotCoefficients.SHOOTSLOT1), indexer.pitchToLauncher(), new WaitCommand(850),
                        indexer.fireSlot(RobotCoefficients.SHOOTSLOT3), indexer.pitchToLauncher(), new WaitCommand(850),
        ...
        Command intake1stCycle = new SequentialCommandGroup(
                ...
                intake3rd, wait, driveTo(moveToCollect1stcycle1stBall, "1st Cycle 3rd Ball") , wait, moveIntakeUp,
                intake1st, wait, driveTo(moveToCollect1stcycle2ndBall, "1st Cycle 1st Ball") , wait, moveIntakeUp,
                intake2nd, wait, driveTo(moveToCollect1stcycle3rdBall, "1st Cycle 2nd Ball") , wait, moveIntakeUp,
